...
def object_recognition():
    ...
    GRAPH_NAME = 'detect.tflite'  # DEFAULT NAME
    LABELMAP_NAME = 'labelmap.txt'  # DEFAULT NAME
    min_conf_threshold = float(0.5)  # Confidence Threshold to SHOW
    resW, resH = 1280, 720
    ...
    while True:
        ...
        for i in range(len(scores)):
            if (scores[i] > min_conf_threshold) and (scores[i] <= 1.0):
                ...
                # print(center)
                if 600 < center[0] < 680 and object_name == "W_Front":
                    print('CENTERED')
                elif center[0] < 640:
                    print("Located Left Side")
                elif center[0] > 640:
                    print("Located Right Side")
